...
const OU_DORMIR_TYPES: [string, string, string, string][] = [
  ...
  ["hotels-milieu-de-gamme", "mid-range-hotels", "Hôtels 3★ rapport qualité-prix", "Mid-range 3-star hotels best value"],
  ...
  ["thalasso", "thalasso-hotels", "Hôtels thalasso et remise en forme", "Thalasso and wellness hotels"],
