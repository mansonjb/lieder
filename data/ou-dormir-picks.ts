...
const TOIRAS: OuDormirPick = {
  ...
  photoIndex: 0,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/666796841.jpg?auto=format&w=800&q=80",
...
const BARONNIE: OuDormirPick = {
  ...
  villageSlug: "saint-martin-de-re",
  photoIndex: 2,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/377562272.jpg?auto=format&w=800&q=80",
...
const MARTRAY: OuDormirPick = {
  ...
  villageSlug: "ars-en-re",
  photoIndex: 1,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/843087333.jpg?auto=format&w=800&q=80",
...
const OCEAN_BOIS: OuDormirPick = {
  ...
  photoIndex: 2,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/121080133.jpg?auto=format&w=800&q=80",
...
const MAISON_PHARE: OuDormirPick = {
  ...
  villageSlug: "saint-clement-des-baleines",
  photoIndex: 1,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/483415324.jpg?auto=format&w=800&q=80",
  type: { fr: "Chambre d'hôtes", en: "B&B" },
  priceLevel: 3,
  features: [
...
const MAREE_STE_MARIE: OuDormirPick = {
  ...
  villageSlug: "sainte-marie-de-re",
  photoIndex: 1,
  imageUrl: "https://cf.bstatic.com/xdata/images/hotel/max1024x768/210236628.jpg?auto=format&w=800&q=80",
  type: { fr: "Hôtel 3★", en: "3★ hotel" },
  stars: 3,
  priceLevel: 2,
  features: [
